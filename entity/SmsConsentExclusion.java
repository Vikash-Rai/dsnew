...
@Entity
@Table(schema = "data", name = "smsconsentexclusion")
public class SmsConsentExclusion implements Serializable {
	/**
	 * 
	 */
	...
	@Column(name = "smsconsentexclusion_id")
	private Long smsConsentExclusionId;
	...
	public Long getSmsConsentExclusionId() {
		return smsConsentExclusionId;
	}

	public void setSmsConsentExclusionId(Long smsConsentExclusionId) {
		this.smsConsentExclusionId = smsConsentExclusionId;
	}
