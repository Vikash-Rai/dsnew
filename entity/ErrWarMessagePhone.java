...
@Entity
@Table(schema = "data", name = "vwerrwarmessage_phone")
public class ErrWarMessagePhone  implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4440789494803918589L;
